...
key_map("n", "<leader>st", ":lua require'jr.telescope'.search_todos()<CR>", { noremap = true, silent = true })
...
-- telescope-repo
key_map("n", "<leader>rl", [[<Cmd>lua require'jr.telescope'.repo_list()<CR>]], { noremap = true, silent = true })
...
key_map("n", ",<space>", [[<Cmd>lua require'jr.telescope'.project_files()<CR>]], { noremap = true, silent = true })
-- Explore files starting at $HOME
key_map("n", ",e", [[<Cmd>lua require'jr.telescope'.file_explorer()<CR>]], { noremap = true, silent = true })
...
key_map("n", "<leader>e", [[<Cmd>lua require'jr.telescope'.find_configs()<CR>]], { noremap = true, silent = true })
-- greg for a string
key_map("n", "<space>g", [[<Cmd>lua require'jr.telescope'.grep_prompt()<CR>]], { noremap = true, silent = true })
-- find or create neovim configs
key_map("n", "<leader>nc", [[<Cmd>lua require'jr.telescope'.nvim_config()<CR>]], { noremap = true, silent = true })
...
key_map("n", "<leader>ns", [[<Cmd>lua require'jr.telescope'.grep_nvim_src()<CR>]], { noremap = true, silent = true })
-- End Telescope maplocal key_map = vim.api.nvim_set_keymap
-- -- TELESCOPE keymaps  --
-- -- Search through your Neovim related todos
-- key_map("n", "<leader>st", ":lua require'jr.telescope'.search_todos()<CR>", { noremap = true, silent = true })
--
...
--                                                                                                                                           key_map("n", ",n", [[<Cmd>lua require'jr.telescope'.browse_notes()<CR>]], { noremap = true, silent = true })
--                                                                                                                                           -- Explore files starting at $HOME
--                                                                                                                                           key_map("n", ",e", [[<Cmd>lua require'jr.telescope'.file_explorer()<CR>]], { noremap = true, silent = true })
--                                                                                                                                           -- Browse files from cwd - File Browser
--                                                                                                                                           key_map(
...
--
--                                                                                                                                                           -- find notes
--                                                                                                                                                           key_map("n", "<leader>n", [[<Cmd>lua require'jr.telescope'.find_notes()<CR>]], { noremap = true, silent = true })
--                                                                                                                                                           -- search notes
--                                                                                                                                                           key_map("n", "<space>n", [[<Cmd>lua require'jr.telescope'.grep_notes()<CR>]], { noremap = true, silent = true })
--                                                                                                                                                           -- Find files in config dirs
--                                                                                                                                                           key_map("n", "<space>e", [[<Cmd>lua require'jr.telescope'.find_configs()<CR>]], { noremap = true, silent = true })
--                                                                                                                                                           -- greg for a string
--                                                                                                                                                           key_map("n", "<space>g", [[<Cmd>lua require'jr.telescope'.grep_prompt()<CR>]], { noremap = true, silent = true })
--                                                                                                                                                           -- find or create neovim configs
--                                                                                                                                                           key_map("n", "<leader>nc", [[<Cmd>lua require'jr.telescope'.nvim_config()<CR>]], { noremap = true, silent = true })
--
--                                                                                                                                                           -- Github issues
--                                                                                                                                                           key_map("n", "<leader>is", [[<Cmd>lua require'jr.telescope'.gh_issues()<CR>]], { noremap = true, silent = true })
--                                                                                                                                                           -- github PRs
--                                                                                                                                                           key_map("n", "<leader>pr", [[<Cmd>lua require'jr.telescope'.gh_prs()<CR>]], { noremap = true, silent = true })
--
--                                                                                                                                                           -- neoclip
--                                                                                                                                                           key_map(
--                                                                                                                                                             "n",
